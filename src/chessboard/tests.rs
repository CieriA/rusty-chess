...
fn cannot_eat_straight() {
    ...
    for mov in movements {
        assert!(!board.filtered_move_set(pawn_pos).contains(&mov));
    }
}
...
fn bishop_colliding() {
    ...
    assert_eq!(
        board.filtered_move_set(pos),
        [
            piece.to_movement(Point::new(1, 1), None, Some(Direction::UpRight),),
            piece.to_movement(Point::new(2, 2), None, Some(Direction::UpRight),),
            piece.to_movement(Point::new(-1, -1), None, Some(Direction::DownLeft),),
            piece.to_movement(Point::new(1, -1), None, Some(Direction::DownRight),),
            piece.to_movement(Point::new(-1, 1), None, Some(Direction::UpLeft),),
            piece.to_movement(Point::new(-2, 2), None, Some(Direction::UpLeft),),
            piece.to_movement(Point::new(-3, 3), None, Some(Direction::UpLeft),),
        ]
        .into_iter()
        .flatten()
        .collect::<IndexSet<_>>()
...
fn bishop_stuck() {
    ...
    assert_eq!(board.filtered_move_set(Point::new(2, 0)), IndexSet::new());
    assert_eq!(board.filtered_move_set(Point::new(2, 7)), IndexSet::new());
    assert_eq!(board.filtered_move_set(Point::new(5, 0)), IndexSet::new());
...
fn rook_not_colliding() {
    ...
    assert_eq!(board.filtered_move_set(pos), piece.move_set());
}
#[test]
fn rook_stuck() {
    let board = Board::default();
    assert_eq!(board.filtered_move_set(Point::new(0, 0)), IndexSet::new());
    assert_eq!(board.filtered_move_set(Point::new(0, 7)), IndexSet::new());
    assert_eq!(board.filtered_move_set(Point::new(7, 0)), IndexSet::new());
...
fn queen_stuck() {
    let board = Board::default();
    assert_eq!(board.filtered_move_set(Point::new(3, 0)), IndexSet::new());
...
fn king_stuck() {
    let board = Board::default();
    assert_eq!(board.filtered_move_set(Point::new(4, 0)), IndexSet::new());
